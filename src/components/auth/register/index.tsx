...
const RegisterPage = () => {
    return (
        <>
            ...
            <TextField fullWidth={true} margin='normal' label="User name" variant="outlined"
            ...
            <Typography variant="body1" sx={{fontFamily:'Poppins'}}> Have a account? <span className="incitingText">Authorisation</span>
